...
void RenderWindow::setupGfxGpu()
{
	...
	shaderSprite = std::make_unique<Shader>("SSprite", Vector<ShortString>{ "position", "texCoord" });
	shaderRectShape = std::make_unique<Shader>("SRectShape", Vector<ShortString>{ "position" });
