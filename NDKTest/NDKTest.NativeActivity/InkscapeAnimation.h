...
public:
	InkscapeAnimation(const std::vector<std::string>& regionNames, const TextureAtlas& atlas, const std::string& inkscapeFileName, TextureAssetManager* assetManager, int64_t frameDuration = Time::seconds(0.2f).asMicroseconds(), PlayMode type = PlayMode::LOOPED);
	...
	void setInkscapeAnimationElement(const std::string& inkscapeFileName, const std::vector<std::string>& regionNames, TextureAssetManager* assetManager);
