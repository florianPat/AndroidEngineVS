...
public:
	InkscapeAnimation(const std::vector<std::string>& regionNames, const TextureAtlas& atlas, const std::string& inkscapeFileName, int64_t frameDuration = sf::seconds(0.2f).asMicroseconds(), PlayMode type = PlayMode::LOOPED);
	InkscapeAnimation(const std::vector<std::string>& regionNames, const TextureAtlas& atlas, const InkscapeAnimationElement& iae, int64_t frameDuration = sf::seconds(0.2f).asMicroseconds(), PlayMode type = PlayMode::LOOPED);
